...
if (linechartDatalabelColors) {
    var options = {
        ...
        series: [{
                ...
                data: [null, null, null, 31, 40, 48, 60, 66, 73, 80, 91,100]
            },
            {
                name: "Realisasi Keuangan",
                data: [null, null, null, null, 40, 53, 64, 69, 77, 85, 96,100]
            }
        ],
        title: {
            text: 'test',
        ...
        xaxis: {
            categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul','Agst', 'Sept', 'Okt', 'Nov', 'Des'],
            title: {
                text: 'Bulan'
            }
        },
