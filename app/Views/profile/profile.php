                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="fs-16 fw-medium pt-0"><?= $user['user_id']; ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="fs-16 fw-medium pt-0"><?= $user['nama']; ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <span class="text-muted">NIK </span>
                                                        <p class="fs-16 fw-medium pt-0"><?= ($user['ktp'] ? $user['ktp'] : '-'); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <span class="text-muted">No. Handphone (WA Aktif) </span>
                                                        <p class="fs-16 fw-medium pt-0"><?= ($user['kontak'] ? $user['kontak'] : '-'); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="fs-16 fw-medium pt-0"><?= (!empty($user['email']) ? $user['email'] : '-'); ?></p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
