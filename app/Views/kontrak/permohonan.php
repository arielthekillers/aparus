...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Permohonan')); ?>
    <!-- glightbox css -->
                        ...
                        <?php if (!empty($permohonan)) : ?>
                            <div class="col-lg-12 text-center">
                                ...
                                <div class="alert alert-success material-shadow" role="alert">
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/vistbkts.json" trigger="loop" delay="500" stroke="light" state="in-reveal" style="width:80px;height:80px">
                                    </lord-icon>
                                    <br />
                                    <?php if ($permohonan['status_kontrak'] == "Permohonan") : ?>
                                        <strong> Permohonan telah terkirim. </strong><br />Tim kami akan melakukan verifikasi data dan menghubungi anda segera
                                    <?php elseif ($permohonan['status_kontrak'] == "Daftar Tunggu") : ?>
                                        <strong> Anda telah masuk "Daftar Tunggu". </strong><br />Tim kami akan mencarikan lokasi tinggal untuk anda, dan melanjutkan ke proses kontrak.
                                    <?php elseif ($permohonan['status_kontrak'] == "Terkontrak") : ?>
                                        <strong> Selamat, Kontrak anda telah terbit. </strong><br />Lihat detailnya <a href="#" class="text-dark fw-semibold">disini.</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex bg-primary">
                                    <h4 class="card-title mb-0 flex-grow-1 text-white">Form Permohonan Kontrak</h4>
                                </div><!-- end card header -->
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <form class="row g-3" method="POST" action="<?= site_url('kontrak/kirimpermohonan'); ?>">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input checkbox" type="checkbox" value="" id="invalidCheck1" required>
                                                            <label class="form-check-label" for="invalidCheck1">
                                                                Saya menyatakan data yang saya isi adalah data yang benar dan dapat dipertanggung jawabkan.
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input checkbox" type="checkbox" value="" id="invalidCheck2" required>
                                                            <label class="form-check-label" for="invalidCheck2">
                                                                Saya menyatakan telah membaca seluruh ketentuan dan persyaratan yang ada.
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <button class="btn btn-primary" id="btn" type="submit" disabled>Kirim Permohonan</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
