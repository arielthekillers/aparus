        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Invoice', 'title' => 'Detail')); ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card-body p-4">
                                                        ...
                                                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                                            <a href="#" class="btn btn-primary" onclick="history.back()"><i class="ri-arrow-left-line align-bottom me-1"></i> Kembali</a>
                                                        </div>
                                                    </div>
                                                    <!--end card-body-->
                                                </div><!--end col-->
