...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <h5 class="m-0 me-2 text-white">Pengaturan Tampilan</h5>
            ...
            <div class="p-4">
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <h5 class="fs-13 text-center mt-2">Vertikal</h5>
                    </div>
                    <div class="col-4">
                        <div class="form-check card-radio">
                    ...
                    <div class="col-4">
                        ...
                        <h5 class="fs-13 text-center mt-2">2 Column</h5>
                    </div>
                    <!-- end col -->
                </div>

                <h6 class="mt-4 mb-0 fw-semibold text-uppercase fs-12">Skema Warna</h6>
                <p class="text-muted">Pilih Skema Warna Terang atau Gelap.</p>
