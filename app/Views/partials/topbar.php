            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="/" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="/assets/images/logo-dark.png" alt="" width="90%">
                        </span>
                    </a>
                    ...
                    <a href="/" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="/assets/images/logo-light.png" alt="" width="90%">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fw-semibold fs-15"> Aplikasi Lainnya </h6>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="p-2">
                            <div class="row g-0">
                                <?= view_cell('App\Controllers\Shortcut::loadShortcut') ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Log In sebagai <?= session('role'); ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Hi <?= session('nama'); ?></h6>
                        <a class="dropdown-item" href="<?= site_url('profil'); ?>"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profil Saya</span></a>
                        <a class="dropdown-item" href="<?= site_url('profil/update'); ?>"><i class="mdi mdi-account-edit text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Update Profile</span></a>
                        <a class="dropdown-item" href="<?= site_url('profil/updatepassword'); ?>"><i class="mdi mdi-lock-reset text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Update Password</span></a>
                        <a class="dropdown-item" href="<?= site_url('profil/updatefoto'); ?>"><i class="mdi mdi-camera-plus text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Update Foto</span></a>
                        <div class="dropdown-divider"></div>
                        <?php if (session('rolecount') > 1) : ?><a class="dropdown-item" href="<?= site_url('auth/switcher'); ?>"><i class="mdi mdi-account-switch-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Switch Role</span></a><?php endif; ?>
