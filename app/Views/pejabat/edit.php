...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Edit Pejabat')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Pejabat', 'title' => 'Edit Pejabat')); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input autofocus required type="text" class="form-control" placeholder="Input Nama" id="nama" name="nama" value="<?= $pejabat['nama']; ?>">
                                                                <input required type="text" name="id" value="<?= $pejabat['id_pejabat']; ?>" class="d-none">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Input Nip" id="nip" name="nip" value="<?= $pejabat['nip']; ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Input Jabatan" id="jabatan" name="jabatan" value="<?= $pejabat['jabatan']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
