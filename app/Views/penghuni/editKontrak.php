            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row alert-message">
                        <div class="col-lg-12">
                            <!-- Success Alert -->
                            <div class="alert alert-<?= session()->get('color'); ?> alert-border-left alert-dismissible fade shadow show"
                                role="alert">
                        ...
                        <div class="col-xl-12">
                            <div class="card text-center">
                                <div class="card-body my-5">
                                    ...
                                    <a href="<?= site_url('kontrak/create/' . session('userid')) ?>"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Form Input Penghuni</h4>
                                </div><!-- end card header -->
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form action="<?= site_url('kontrak/save'); ?>" method="POST">
                                            <input type="hidden" name="id_penghuni"
                                            ...
                                            <div class="row">
                                                <div class="col-6 border-end">
                                                    <div class="row">
                                                        ...
                                                        <h5 class="fs-15 text-primary mb-4">Informasi Penghuni</h5>
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    placeholder="Tanggal Lahit" id="tanggal_lahir"
                                                                    name="tanggal_lahir"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control"
                                                                    ...
                                                                    name="alamat" rows="3"
                                                                    value=""><?= $penghuni['alamat']; ?></textarea>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    <option value="Laki-laki"
                                                                        <?= ($penghuni['jeniskelamin'] == 'Laki-laki' ? 'selected' : ''); ?>>
                                                                        Laki-laki</option>
                                                                    <option value="Perempuan"
                                                                        <?= ($penghuni['jeniskelamin'] == 'Perempuan' ? 'selected' : ''); ?>>
                                                                        Perempuan</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukkan Pekerjaan" id="pekerjaan"
                                                                    name="pekerjaan"
                                                                    value="<?= $penghuni['pekerjaan']; ?>">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    <option value="Katholik"
                                                                        <?= ($penghuni['agama'] == 'Katholik' ? 'selected' : ''); ?>>
                                                                        Katholik</option>
                                                                    <option value="Protestan"
                                                                        <?= ($penghuni['agama'] == 'Protestan' ? 'selected' : ''); ?>>
                                                                        Protestan</option>
                                                                    <option value="Hindu"
                                                                    ...
                                                                    <option value="Konghucu"
                                                                        <?= ($penghuni['agama'] == 'Konghucu' ? 'selected' : ''); ?>>
                                                                        Konghucu</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select"
                                                                    aria-label="Default select example"
                                                                    id="statusmenikah" name="statusmenikah">
                                                                    <option selected>-- Pilih --</option>
                                                                    <option value="Kawin"
                                                                        <?= ($penghuni['statusmenikah'] == 'Kawin' ? 'selected' : ''); ?>>
                                                                        Kawin</option>
                                                                    <option value="Belum Kawin"
                                                                        <?= ($penghuni['statusmenikah'] == 'Belum Kawin' ? 'selected' : ''); ?>>
                                                                        Belum Kawin</option>
                                                                    <option value="Cerai Hidup"
                                                                        <?= ($penghuni['statusmenikah'] == 'Cerai Hidup' ? 'selected' : ''); ?>>
                                                                        Cerai Hidup</option>
                                                                    <option value="Cerai Mati"
                                                                        <?= ($penghuni['statusmenikah'] == 'Cerai Mati' ? 'selected' : ''); ?>>
                                                                        Cerai Mati</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                <label for="jumlahanggotakeluarga"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?= $penghuni['jumlahanggotakeluarga']; ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select"
                                                                    aria-label="Default select example"
                                                                    id="statusdifabel" name="statusdifabel">
                                                                    <option selected>-- Pilih --</option>
                                                                    <option value="Digabel"
                                                                        <?= ($penghuni['statusdifabel'] == 'Digabel' ? 'selected' : ''); ?>>
                                                                        Difabel</option>
                                                                    <option value="Non Difabel"
                                                                        <?= ($penghuni['statusdifabel'] == 'Non Difabel' ? 'selected' : ''); ?>>
                                                                        Non Difabel</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukkan Password" id="kontak"
                                                                    name="kontak" value="<?= $penghuni['kontak']; ?>">
                                                            </div>
                                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center text-muted">
                                                    ...
                                                    <td class="text-center fw-medium fs-12">
                                                        <a href="/uploads/dokumen/<?= $dok['dokumen']; ?>"
                                                            target="_blank">
                                                            <?= $dok['dokumen']; ?>
                                                        </a>
                                                        <?php
                                                            ...
                                                            ?>
                                                        <span
                                                            class="badge rounded-pill bg-primary ms-2"><?= $fsize; ?></span>
                                                    </td>
                                                    <td class="text-center fw-medium fs-12">
                                                        <?= timestamp($dok['time']); ?>
                                                    </td>
                                                    <td class="text-center fw-medium fs-12">
                                                        <a href="<?= site_url('dokumen/delete/' . $dok['dokumen'] . '/' . $dok['id_dokumen'] . '/' . $dok['id_penghuni']); ?>"
                                                            onclick="return confirm('Anda yakin ingin menghapus dokumen ini?');"><i
                                                                class="ri-delete-bin-fill align-bottom me-2 text-danger "></i></a>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card text-center">
                                            <div class="card-body my-5">
                                                ...
                                                <form action="<?= site_url('kontrak/verif'); ?>" method="POST">
                                                    <input type="hidden" name="id_penghuni"
                                                        value="<?= $penghuni['id_penghuni']; ?>">
