                            ...
                            <div class="col-xl-12">
                                <div class="card text-center">
                                    <div class="card-body my-5">
                                        ...
                                        <a href="<?= site_url('kontrak/save/') ?>" class="btn btn-primary">AJUKAN
                                            KONTRAK</a>
                                    </div>
                                </div> <!-- end col -->
                            </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example" id="jeniskelamin" name="jeniskelamin">
                                                                        ...
                                                                        <option value="Laki-laki" <?= ($penghuni['jeniskelamin'] == 'Laki-laki' ? 'selected' : ''); ?>>
                                                                            Laki-laki</option>
                                                                        <option value="Perempuan" <?= ($penghuni['jeniskelamin'] == 'Perempuan' ? 'selected' : ''); ?>>
                                                                            Perempuan</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example" id="agama" name="agama">
                                                                        <option value="Islam" <?= ($penghuni['agama'] == 'Islam' ? 'selected' : ''); ?>>
                                                                            Islam</option>
                                                                        <option value="Katholik" <?= ($penghuni['agama'] == 'Katholik' ? 'selected' : ''); ?>>
                                                                            Katholik</option>
                                                                        <option value="Protestan" <?= ($penghuni['agama'] == 'Protestan' ? 'selected' : ''); ?>>
                                                                            Protestan</option>
                                                                        <option value="Hindu" <?= ($penghuni['agama'] == 'Hindu' ? 'selected' : ''); ?>>
                                                                            Hindu</option>
                                                                        <option value="Budha" <?= ($penghuni['agama'] == 'Budha' ? 'selected' : ''); ?>>
                                                                            Budha</option>
                                                                        <option value="Konghucu" <?= ($penghuni['agama'] == 'Konghucu' ? 'selected' : ''); ?>>
                                                                            Konghucu</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example" id="rusuntujuan" name="rusuntujuan">
                                                                        ...
                                                                        <?php foreach ($rusun as $r) : ?>
                                                                            <option value="<?= $r['rusun_nama']; ?>"><?= $r['rusun_nama']; ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="card-body my-5">
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        <?php else : ?>
                                                            ...
                                                            <p class="card-text">Silahkan KKlik Verifikasi Untuk Mengirim Data</p>
