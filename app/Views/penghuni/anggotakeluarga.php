...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Anggota keluarga')); ?>
    <!-- glightbox css -->
                                ...
                                <div class="col-lg-9">
                                    <div class="card">
                                        <div class="card-header align-items-center d-flex border-0">
                                            <h4 class="card-title mb-0 flex-grow-1">Anggota Keluarga</h4>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex flex-wrap gap-2">
                                                    <button class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#modalAngkotakeluarga"><i class="ri-add-line align-bottom me-1"></i> Tambah Anggota Keluarga</button>
                                                    <div class="modal fade" id="modalAngkotakeluarga" tabindex="-1" aria-labelledby="modalAngkotakeluargaLabel" aria-modal="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="modalAngkotakeluargaLabel">Tambah Anggota Keluarga</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form action="<?= site_url('penghuni/savedatakeluarga'); ?>" method="POST" enctype="multipart/form-data">
                                                                        <input type="hidden" class="form-control" name="kode_penghuni" value="<?= $kode; ?>" required>
                                                                        <div class="row g-3">
                                                                            <div class="col-12">
                                                                                <div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                <select class="form-select" aria-label="Jenis Kelamin" id="jenis_kelamin" name="jenis_kelamin" required>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                <select class="form-select" aria-label="Status" id="statusKeluarga" name="status" required>
                                                                                    <option value="" default selected>-- Pilih --</option>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                <select class="form-select" aria-label="Pendidikan" id="pendidikan" name="pendidikan">
                                                                                    <option value="" default selected>-- Pilih --</option>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div>
                                                                                    ...
                                                                                    <input type="text" class="form-control" placeholder="Pendapatan Per Bulan" id="pendapatan" name="pendapatan">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="hstack gap-3 flex-wrap">
                                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalAnggotakeluargaEdit" data-id="<?= $data['id_anggotakeluarga']; ?>">
                                                                                <i class="ri-edit-2-line"></i>
                                                                            </a>
                                                                            <a href="<?= site_url('penghuni/deleteanggotakeluarga/' . $data['id_anggotakeluarga'] . '/' . $data['kode_penghuni']); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');" class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <?php $no += 1; ?>
